...
ExtensionStrategyFactory::ExtensionStrategyFactory(utils::Verbosity verbosity)
    : log(utils::get_log_for_verbosity(verbosity)) {
}

void ExtensionStrategyFactory::dump_options() const {
...
static class ExtensionStrategyFactoryCategoryPlugin
    : public plugins::TypedCategoryPlugin<ExtensionStrategyFactory> {
public:
    ExtensionStrategyFactoryCategoryPlugin()
